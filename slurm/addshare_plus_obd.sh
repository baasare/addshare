...
python ~/projects/def-pbranco/baasare/thesis/addshare_plus.py cifar-10 obd
python ~/projects/def-pbranco/baasare/thesis/addshare_plus.py f-mnist obd
python ~/projects/def-pbranco/baasare/thesis/addshare_plus.py mnist obd
python ~/projects/def-pbranco/baasare/thesis/addshare_plus.py svhn obd
# ---------------------------------------------------------------------
